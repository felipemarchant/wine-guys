package br.com.felipemarchant.wineguys.mail;
...
public class Mailer {
	...
	public void enviar(Venda venda) {
		...
		boolean adicionarMockVinho = false;
		for (ItemVenda item : venda.getItens()) {
			Vinho vinho = item.getVinho();
			if (vinho.temFoto()) {
				String cid = "foto-" + vinho.getCodigo();
				context.setVariable(cid, cid);
				
				fotos.put(cid, vinho.getFoto() + "|" + vinho.getContentType());
			} else {
				adicionarMockVinho = true;
				context.setVariable("mockVinho", "mockVinho");
			}
		}
		...
		try {
			...
			helper.setSubject(String.format("WineGuys - Venda nº %d", venda.getCodigo()));
			helper.setText(email, true);
			
			helper.addInline("logo", new ClassPathResource("static/images/logo-gray.png"));
			
			if (adicionarMockVinho) {
				helper.addInline("mockVinho", new ClassPathResource("static/images/vinho-mock.png"));
			}
