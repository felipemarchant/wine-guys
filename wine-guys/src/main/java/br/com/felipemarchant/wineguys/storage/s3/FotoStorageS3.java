package br.com.felipemarchant.wineguys.storage.s3;
...
public class FotoStorageS3 implements FotoStorage {
	...
	private static final String BUCKET = "aw-wineguys-fotos";
	...
	public String getUrl(String foto) {
		if (!StringUtils.isEmpty(foto)) {
			return "https://s3-us-west-2.amazonaws.com/aw-wineguys-fotos/" + foto;
		}
