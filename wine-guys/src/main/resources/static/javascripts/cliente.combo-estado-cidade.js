...
$(function() {
	...
	var comboEstado = new WineGuys.ComboEstado();
	comboEstado.iniciar();
	
	var comboCidade = new WineGuys.ComboCidade(comboEstado);
	comboCidade.iniciar();
