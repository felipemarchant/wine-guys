WineGuys.TabelaItens = (function() {
	...
	TabelaItens.prototype.valorTotal = function() {
		return this.tabelaVinhosContainer.data('valor');
	}
	...
	function onExclusaoItemClick(evento) {
		...
		var resposta = $.ajax({
			url: 'item/' + this.uuid + '/' + codigoVinho,
			method: 'DELETE'
		});
	...
	function bindQuantidade() {
		var quantidadeItemInput = $('.js-tabela-vinho-quantidade-item');
